...
import { ArrowRight, Calendar, CheckCircle2, Clock, CreditCard, MessageSquare, Star, Users, Scissors } from "lucide-react"
...
function jsonLd() {
  const faqs = [
    ...
    { q: "¿Necesito tarjeta para probar?", a: "No. Tenés 14 días gratis sin tarjeta." },
  ]
  ...
  const appSchema = {
    ...
    featureList: [
      "Turnero online para barberías",
      "Agenda por barbero",
      "Página de reservas 24/7",
      "Recordatorios",
    ...
    >
      ...
      <main className="relative z-10">
        <section className="mx-auto max-w-6xl px-5 pt-20 pb-16">
          ...
          <div className="relative">
            <p className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-blue-400 mb-4">
              <Scissors className="w-4 h-4" /> Turnero online para barberías
            </p>
            <h1 className="heading-font text-5xl sm:text-6xl font-900 leading-[1.05] mb-5">
              ...
              <span className="shimmer-text">barberías en Argentina</span>
            </h1>
            <p className="text-lg text-white/50 leading-relaxed max-w-2xl mb-6">
              Armá tu <strong className="text-white/70">agenda de barbería</strong>, dejá que los clientes reserven 24/7 y pedí <strong className="text-white/70">seña con MercadoPago</strong> para reducir ausencias.
            </p>
        ...
        <section className="mx-auto max-w-6xl px-5 py-20">
          <div className="gradient-border rounded-3xl p-8 sm:p-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { icon: MessageSquare, t: "WhatsApp infinito", d: "Menos mensajes para coordinar horarios." },
                { icon: Clock, t: "No-shows", d: "Señas + recordatorios para bajar ausencias." },
                { icon: Users, t: "Varios barberos", d: "Agenda por profesional, sin cruces." },
                { icon: Calendar, t: "Agenda ordenada", d: "Servicios, duraciones y precios claros." },
              ].map((c) => {
                const Icon = c.icon
                return (
        ...
        <section className="mx-auto max-w-6xl px-5 py-20 border-t border-white/[0.06]">
          <div className="mb-12">
            <h2 className="heading-font text-3xl sm:text-4xl font-900 text-white mb-3">
              Cómo funciona (barbería)
            </h2>
            <p className="text-white/40 max-w-2xl">
              Configurás una vez y después tu agenda se gestiona sola.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-5">
            {[
              { t: "Cargás servicios", d: "Corte, barba, combo, duración y precio.", icon: CheckCircle2 },
              { t: "Sumás barberos", d: "Cada uno con su disponibilidad.", icon: Users },
              { t: "Activás seña", d: "Cobrás con MercadoPago y confirmás turnos.", icon: CreditCard },
            ].map((s) => {
              const Icon = s.icon
              return (
        ...
        <section className="mx-auto max-w-6xl px-5 py-20 border-t border-white/[0.06]">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              { q: "¿Puedo ofrecer varios servicios con distintas duraciones?", a: "Sí. Configurás servicios (corte, barba, combo) con duración y precio." },
              { q: "¿El cliente puede elegir barbero?", a: "Sí. Puede elegir profesional y horario disponible." },
              { q: "¿Puedo pedir seña del 50%?", a: "Sí. Podés definir el porcentaje de seña y cobrar con MercadoPago." },
              { q: "¿Sirve si tengo una sola silla?", a: "Sí. Funciona tanto para barberías chicas como para equipos." },
            ].map((f) => (
