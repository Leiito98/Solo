...
import { ArrowRight, Calendar, CheckCircle2, Clock, CreditCard, MessageSquare, Star, Users, Target } from "lucide-react"
...
function jsonLd() {
  const faqs = [
    { q: "¿Solo sirve para nutricionistas?", a: "Sí. Te permite ofrecer turnos online, ordenar agenda, enviar recordatorios y cobrar señas." },
    { q: "¿Puedo organizar consultas presenciales y online?", a: "Sí. Podés cargar servicios distintos (presencial/online) con duraciones y precios." },
    { q: "¿Se puede cobrar seña con MercadoPago?", a: "Sí. Cobrás seña para confirmar turnos y reducir cancelaciones." },
    { q: "¿Envía recordatorios?", a: "Sí. Podés automatizar recordatorios y confirmaciones." },
    { q: "¿Necesito tarjeta?", a: "No. Tenés 14 días gratis sin tarjeta." },
  ]
  ...
  const appSchema = {
    ...
    featureList: [
      "Agenda online para nutricionistas",
      "Reservas 24/7",
      "Recordatorios",
      "Señas con MercadoPago",
      "Servicios por tipo de consulta",
    ],
  }
    ...
    >
      ...
      <main className="relative z-10">
        <section className="mx-auto max-w-6xl px-5 pt-20 pb-16">
          ...
          <div className="relative">
            <p className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-blue-400 mb-4">
              <Target className="w-4 h-4" /> Agenda online para nutricionistas
            </p>
            <h1 className="heading-font text-5xl sm:text-6xl font-900 leading-[1.05] mb-5">
              ...
              <span className="shimmer-text">nutricionistas en Argentina</span>
            </h1>
            <p className="text-lg text-white/50 leading-relaxed max-w-2xl mb-6">
              Ofrecé <strong className="text-white/70">turnos online</strong>, ordená tus consultas y cobrá <strong className="text-white/70">señas con MercadoPago</strong> para reducir cancelaciones.
            </p>
        ...
        <section className="mx-auto max-w-6xl px-5 py-20">
          <div className="gradient-border rounded-3xl p-8 sm:p-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { icon: MessageSquare, t: "Menos mensajes", d: "Tus pacientes reservan sin ida y vuelta." },
                { icon: Clock, t: "Menos cancelaciones", d: "Seña + recordatorios para confirmar." },
                { icon: Calendar, t: "Agenda clara", d: "Consultas presenciales/online con duraciones." },
                { icon: Users, t: "Organización", d: "Todo en un solo lugar, sin planillas." },
              ].map((c) => {
                const Icon = c.icon
                return (
        ...
        <section className="mx-auto max-w-6xl px-5 py-20 border-t border-white/[0.06]">
          <div className="mb-12">
            <h2 className="heading-font text-3xl sm:text-4xl font-900 text-white mb-3">
              Cómo funciona (nutrición)
            </h2>
            <p className="text-white/40 max-w-2xl">
              Tres pasos simples para digitalizar tu agenda de consultas.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-5">
            {[
              { t: "Creás servicios", d: "Consulta inicial, seguimiento, online/presencial.", icon: CheckCircle2 },
              { t: "Compartís tu link", d: "Tus pacientes reservan 24/7.", icon: Calendar },
        ...
        <section className="mx-auto max-w-6xl px-5 py-20 border-t border-white/[0.06]">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              { q: "¿Puedo tener turnos online y presenciales?", a: "Sí. Creás servicios distintos y los ofrecés desde la misma agenda." },
              { q: "¿Puedo pedir seña antes de confirmar?", a: "Sí. Podés solicitar seña y cobrar con MercadoPago." },
              { q: "¿Los pacientes pueden reservar a cualquier hora?", a: "Sí. Reservan 24/7 desde tu página." },
